                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="list">
                                ...
                                */
                                $requests = \storify\business_group::getMemberInvitation($current_user->ID);

                                if(sizeof($requests)){
                                    foreach($requests as $key=>$value){
                                        ?>
                                <div class="box">
                                    <img src="https://cdn.storify.me/<?=$value["profile_image"]?>" class="profile">
                                    <div class="body">
                                        <h2><?=$value["name"]?></h2>
                                        <?=$value["brand_name"]?"<h3>".$value["brand_name"]."</h3>":""?>
                                        <form method="post">
                                            <input type="hidden" name="group_id" value="<?=$value["id"]?>" >
                                            <button href="#" type="submit" class="btn btn-primary small">Accept</button>
                                        </form>
                                    </div>
                                </div>
                                        <?php
