                                        ...
                                        <section>
                                            <div class="form-group">
                                                <div class="input-group-row">
                                                    ...
                                                    <input name="business_name" type="text" class="form-control" id="business_name" placeholder="Business Name" value="">
                                                </div>
                    ...
                    ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="profile-image">
                                            <div class="image background-image" id="business_image_preview">
                                            </div>
