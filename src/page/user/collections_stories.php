...
include("page/component/header.php"); ?>
                ...
                <div class="page-title">
                    <div class="container">
                        <h1>Stories</h1>
                        <h2><?php
                        $story_bookmark_result = $main->getSummary("story", -1);
                        echo $story_bookmark_result["no_items"] == 1 ? "1 story saved.":$story_bookmark_result["no_items"]." stories saved";
                        ?></h2>
                    </div>
                    <!--end container-->
                </div>
                        ...
                        <div class="col-md-9">
                            <div class="section-title clearfix hide" id="emptybox">
                                <div class="float-xl-left float-md-left float-sm-none story_tell_cont">
                                    <p>Add stories to your board by clicking the Save button on each post on creator's showcase.</p>
                                </div>
