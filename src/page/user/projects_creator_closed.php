...
include("page/component/header.php"); ?>
                ...
                <div class="page-title">
                    <div class="container">
                        ...
                        <h2>
<?php
                        $total_closed = $main->getProjectManager()->getNumberOfClosedCreator($current_user->ID);
                        if($total_closed == 0){
                            echo "You do not have any closed projects.";
                        }else if($total_closed == 1){
                            echo "You have completed 1 project.";
                        }else{
                            echo "You have completed ".$total_closed." projects.";
                        }
?>  
                        </h2>                        
                    </div>
            ...
            <section class="block">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="project-items" id="closed_grid" data-page="1" data-sort="rev_closing_date" data-filter="close">
                            </div>
                            <div class="center">
