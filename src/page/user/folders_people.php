...
if(isset($_REQUEST["order"])){
 ...
 ?>
                ...
                <div class="page-title">
                    <div class="container">
                        <h1>Creator Boards</h1>
                        <h2><?php
                                $people_summary_result = $main->getSummary("people", -2); //only folder
                                echo ($people_summary_result["no_items"] == 1 ? "1 creator ":$people_summary_result["no_items"]." creators ")."on ".($people_summary_result["no_folder"] == 1 ? "1 board." : $people_summary_result["no_folder"]." boards.");
                            ?>
                        </h2>
                    </div>
                    <!--end container-->
                            ...
                            <div class="section-title clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-2 text-center">
                                        <a class="addnewbutton" href="#" o="people" title="Add a Creator Board" style="font-size:3rem;"><i class="fa fa-plus-square"></i></a>
                                    </div>
                                    <div class="col-5">
          ...
          <form class="storify-form custommsg" novalidate>
              <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-10 offset-md-1">
                        <div class="input-group-row">
                            <label for="folder_name" class="col-form-label required">Enter a new name for your Creator Board</label>
                            <input name="folder_name" type="text" class="form-control" placeholder="Name of Creator Board" value="">
                        </div>
          ...
          <form class="storify-form custommsg" novalidate>
              <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-10 offset-md-1">
                        <div class="input-group-row">
                            <label for="folder_name" class="col-form-label required">Delete Creator Board</label>
        ...
        $(function(){
            ...
            function createFolder($folder_obj){
                ...
                if($folder_obj.first_four.length == 0){
                    ...
                    bgdiv = $("<a>").addClass("image-wrapper background-image").attr({href:link}).css({"background-image":'url('+$folder_obj.first_four[0].data.ig_profile_pic+')'})
                                .append($("<img>").attr({src:$folder_obj.first_four[0].data.ig_profile_pic}));
                }else{
                    bgdiv = $("<a>").addClass("image-wrapper multiple").attr({href:link});
                    for(i=0; i < 4; i++){
                        if(i < $folder_obj.first_four.length){
                            bgdiv.append(
                                $("<span>").addClass("background-image").css({"background-image":'url('+$folder_obj.first_four[i].data.ig_profile_pic+')'})
                                    .append($("<img>").attr({src:$folder_obj.first_four[i].data.ig_profile_pic}))
                                );
                        }else{
                            bgdiv.append(
