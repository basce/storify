...
include_once('NcIgPlatform_InstallIndicator.php');

class NcIgPlatform_LifeCycle extends NcIgPlatform_InstallIndicator {
    ...
    protected function installDatabaseTables() {
        global $wpdb;
        $tableName = $this->prefixTableName('ImageCache');
        $wpdb->query("CREATE TABLE IF NOT EXISTS `".$tableName."` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `url` varchar(2083) COLLATE utf8_bin NOT NULL,
  `cachename` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cachename` (`cachename`),
  KEY `url` (`url`(255))
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin");

        print_r("CREATE TABLE IF NOT EXISTS `".$tableName."` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `url` varchar(2083) COLLATE utf8_bin NOT NULL,
  `cachename` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `url` (`url`(255))
    ...
    protected function addSettingsSubMenuPageToMenu(){
        ...
        add_submenu_page(
            ...
            "set featured posts",
            "manage_options",
            $this->getSettingsSlug()."_featuredposts",
            array(&$this, 'settingsPage_featuredposts'));
