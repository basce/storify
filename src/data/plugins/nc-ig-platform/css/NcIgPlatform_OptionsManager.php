        ...
        if(isset($_GET["id"])){
            ...
            if($pod->display('id')){
                ...
                if($_GET["postpull"] == "auto"){
                    ...
                    /*
                    getting latest 100 posts, select top likes / comments posts as featured posts

                    try{
                        $media = $instagram->getMedias($igname, 100, '');
                    }catch(Exception $e){
                        $media = array();
                        $this->custom_print_r($e);
                        die("Instagram Error, pulling posts fail, refresh and try again");
                    ...
                    $formatted_media = $this->array_orderby($formatted_media, 'likes', SORT_DESC, 'comments', SORT_DESC);
                    
                    $formatted_media = array_slice($formatted_media, 0, 30);
