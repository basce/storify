...
$(document).ready(function($) {
    ...
    if(typeof window.getExecuteTime !== 'undefined'){
        window.getExecuteTime("start of custom");
    }
//  Geo Location button
...
//  Selectize
    ...
    $("[data-enable-search=true]").each(function(){
        ...
        //call $(this)[0].selectize , to access obj
    });
...
//  iCheck
    ...
    $("input[type=checkbox]:not(.customcheck), input[type=radio]:not(.customcheck)").iCheck();
...
//  Read More
    ...
    $("form:not(.custommsg)").each(function(){
        $(this).validate();
    });
