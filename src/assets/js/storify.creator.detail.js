...
//submit submission
    submitSubmision:function(){
        var selectType = "",
            error_alert = $("#submission-content .submission_form_bottom .alert");
        ...
        if(!$("#submission-content .submission_url").val()){
            error_alert.text("Please enter submission file link").removeClass("hide");
            return;
        }

        if($("#submission-content .submission_description").val() && $("#submission-content .submission_description").val().length >= 800){
        ...
        $.ajax({
            ...
            data: {
                ...
                type:selectType,
                URL:$("#submission-content .submission_url").val(),
                remark:$("#submission-content .submission_description").val()
            },
            success:function(rs){
...
//resetSubmission
    resetSubmission:function(){
        $("#submission-content .icon_select a").removeClass("on");
