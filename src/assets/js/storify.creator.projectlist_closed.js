...
storify.creator.projectList_closed = {
    ...
    getProject:function(onComplete){
        if(storify.creator.projectList_closed._gettingProject) return;
        storify.creator.projectList_closed._gettingProject = true;
        ...
        $.ajax({
            ...
            success:function(rs){
                storify.creator.projectList_closed._gettingProject = false;
                if(rs.error){
                    alert(rs.msg);
                }else{
